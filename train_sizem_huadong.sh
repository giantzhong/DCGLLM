...
########################################
# 1. Transformer 任务1(HuaDong) - Train: 80%
########################################
...
########################################
# 2. Transformer 任务2(HuaDong) - Train: 60%
########################################
nohup env CUDA_VISIBLE_DEVICES=2 \
python main_dcgllm.py \
  --dataset HuaDong \
...
########################################
# 3. Transformer 任务3(HuaDong) - Train: 40%
########################################
nohup env CUDA_VISIBLE_DEVICES=2 \
python main_dcgllm.py \
  --dataset HuaDong \
...
########################################
# 4. Transformer 任务4(HuaDong) - Train: 20%
########################################
nohup env CUDA_VISIBLE_DEVICES=2 \
python main_dcgllm.py \
  --dataset HuaDong \
...
########################################
# 5. Transformer 任务5(HuaDong) - Train: 10%
########################################
nohup env CUDA_VISIBLE_DEVICES=2 \
python main_dcgllm.py \
  --dataset HuaDong \
